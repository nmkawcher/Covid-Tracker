...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView tvCases,tvRecovered,tvCritical,tvTodayDeaths,tvTotalDeaths,tvTodayCases,tvAffectedCountries,tvActive;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvAffectedCountries=findViewById(R.id.tvAffectedCountires);
